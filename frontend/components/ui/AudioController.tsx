      ...
      <AnimatePresence>
        {visible && (
          <motion.button
            ...
            className="fixed bottom-6 left-6 z-30 flex h-11 w-11 items-center justify-center rounded-full bg-foreground/5 text-foreground/50 backdrop-blur-sm transition-colors hover:bg-foreground/10 hover:text-foreground/70 focus-visible:ring-2 focus-visible:ring-raspberry focus-visible:ring-offset-2 focus-visible:outline-none"
